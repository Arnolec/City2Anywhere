...
def test_find_trips_no_stop(analyzer) -> None:
    destinations = analyzer.find_trips_between_locations(
        0.0, 0.0, 1.0, 1.0, datetime(2024, 7, 1), datetime(2024, 8, 1), pd.Timedelta(hours=6), 0.5
    )
    assert destinations.shape[0] == 0
...
def test_find_trips_hours_too_late(analyzer) -> None:
    destinations = analyzer.find_trips_between_locations(
        1.0, 1.0, 2.0, 2.0, datetime(2024, 7, 1), datetime(2024, 8, 1), pd.Timedelta(hours=20), 0.5
    )
    assert destinations.shape[0] == 0
...
def test_find_trips_one_single_trip(analyzer) -> None:
    destinations = analyzer.find_trips_between_locations(
        1.0, 1.0, 2.0, 2.0, datetime(2024, 7, 1), datetime(2024, 8, 1), pd.Timedelta(hours=6), 0.5
    )
    assert destinations.shape[0] == 1
...
def test_find_trips_two_same_stops_same_trip_multiple_dates(analyzer) -> None:
    destinations = analyzer.find_trips_between_locations(
        8.0, 8.0, 9.0, 9.0, datetime(2024, 7, 1), datetime(2024, 8, 1), pd.Timedelta(hours=6), 0.5
    )
...
def test_find_trips_one_trip_multiple_dates(analyzer) -> None:
    destinations = analyzer.find_trips_between_locations(
        15.0, 15.0, 5.0, 5.0, datetime(2024, 7, 1), datetime(2024, 8, 1), pd.Timedelta(hours=6), 0.5
    )
...
def test_find_trips_one_trip_multiple_dates2(analyzer) -> None:
    destinations = analyzer.find_trips_between_locations(
        15.0, 15.0, 4.0, 4.0, datetime(2024, 7, 4), datetime(2024, 8, 5), pd.Timedelta(hours=6), 0.5
    )
    assert destinations.shape[0] == 1
...
def test_find_trips_dates_cancelled_trip(analyzer) -> None:
    destinations = analyzer.find_trips_between_locations(
        16.0, 16.0, 17.0, 17.0, datetime(2024, 7, 1), datetime(2024, 7, 8), pd.Timedelta(hours=6), 0.5
    )
    assert destinations.shape[0] == 4
